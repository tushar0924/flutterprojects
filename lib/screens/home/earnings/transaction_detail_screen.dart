                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      icon: const Icon(Icons.support_agent_outlined, color: Colors.white, size: 17),
                      label: const Text(
                        'Contact Support',
                        style: TextStyle(
                          color: Colors.white,
          ...
          Row(
            ...
            children: const [
              CircleAvatar(
                ...
                child: Icon(Icons.south_west_rounded, size: 14, color: Colors.white),
              ),
              SizedBox(width: 8),
              Text(
                'Payment Received',
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Icon(icon, size: 13, color: const Color(0xFF98A2B3)),
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: const [
              Icon(Icons.receipt_outlined, size: 13, color: Color(0xFF98A2B3)),
              SizedBox(width: 6),
              Text(
                'Payment Breakdown',
                style: TextStyle(
      ...
      child: Row(
        ...
        children: [
          const Padding(
            ...
            child: Icon(Icons.info_outline, color: Color(0xFF16A34A), size: 15),
          ),
